...
}};CDNSpeedTest.TestList=function(){this.list=[];this.progress=-1;};CDNSpeedTest.TestList.prototype={constructor:CDNSpeedTest.TestList,result:function(){var c=[],d;
for(d=0;d<this.list.length;d++){c.push(this.list[d].result());console.log(this.list[d]);}return c;},handleEvent:function(d){switch(d.type){case"test.error":case"test.finish":this.progress++;
